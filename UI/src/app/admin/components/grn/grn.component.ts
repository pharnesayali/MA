...
export class GrnComponent implements OnInit {
  ...
  // getGRNData(){
  //   this.spinner.show();
  //   this.http.get<any>("http://localhost:3000/invoiceList").subscribe(res => {
  //     if (res) {
  //       this.GRNData = res;
  //       this.spinner.hide();
  //     }
  ...
  getData() {
    ...
    $(".GNR,.common-bg").show();
    document.getElementById('last-updated-GRN-data').style.display = 'block';
  }

  closeModal() {
    $(".GRN, .common-bg").hide();
    document.getElementById('last-updated-GRN-data').style.display = 'none';
  }
